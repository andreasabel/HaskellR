...
{-@ ignore string @-}
{-@ assume string :: TSEXP s Foreign.R.Type.String -> IO (Ptr (TSEXP s Char)) @-}
...
{-@ assume mkString :: CString -> IO (TSEXP V Foreign.R.Type.String) @-}
...
{-@ assume protect :: a:SEXP s -> IO (TSEXP G (typeOf a)) @-}
